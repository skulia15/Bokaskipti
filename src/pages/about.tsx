  ...
  return (
    <div className={styles.main}>
      <div className='container'>
        ...
        <br />
        <p>
          Join StorySwap today and immerse yourself in a world of endless stories while playing a part in protecting our planet. Happy swapping and happy eco-reading!
        </p>
      </div >
    </div >
  )
